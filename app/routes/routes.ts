...
const models: TsoaRoute.Models = {
    ...
    "UserDTO": {
        ...
        "properties": {
            ...
            "createdAt": {"dataType":"datetime","required":true},
            "userInfo": {"ref":"UserInfoDTO","required":true},
    ...
    "StoryDTO": {
        ...
        "properties": {
            ...
            "reactions": {"dataType":"array","array":{"dataType":"refObject","ref":"ReactionDTO"},"required":true},
            "user": {"ref":"UserDTO","required":true},
            "storyInfo": {"ref":"StoryInfoDTO","required":true},
    ...
    "CreateStoryDTO": {
        ...
        "properties": {
            ...
            "storyInfo": {"dataType":"nestedObjectLiteral","nestedProperties":{"bodyText":{"dataType":"string","required":true},"title":{"dataType":"string","required":true}},"required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/comments/:commentGuid',
            ...(fetchMiddlewares<RequestHandler>(CommentsController)),
